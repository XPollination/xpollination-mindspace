 ...
 * - WORKFLOW.md v0.0.17 exists with changelog (renamed from v17 per v0.0.X convention)
 ...
 * - Create tracks/process/context/workflow/v0.0.17/WORKFLOW.md (v0.0.X convention)
 * - Update symlink tracks/process/context/WORKFLOW.md → workflow/v0.0.17/WORKFLOW.md
...
// --- Change E: WORKFLOW.md v0.0.17 (renamed from v17 per v0.0.X convention) ---
describe("workflow-complete-role-reset: WORKFLOW.md v0.0.17", () => {
  it("v0.0.17 WORKFLOW.md exists", () => {
    expect(existsSync(resolve(PROJECT_ROOT, "tracks/process/context/workflow/v0.0.17/WORKFLOW.md"))).toBe(true);
  });

  it("WORKFLOW.md v0.0.17 mentions role consistency enforcement", () => {
    let content: string;
    try {
      content = readFileSync(resolve(PROJECT_ROOT, "tracks/process/context/workflow/v0.0.17/WORKFLOW.md"), "utf-8");
    } catch {
      content = "";
    }
